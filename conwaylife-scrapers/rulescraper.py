...
samplepath = g.getstring("Enter path to save .rule files","C:/users/{username}/Desktop/LWRules/")
if samplepath == "C:/users/{username}/Desktop/LWRulesz/":
...
for item in articlelist:
  ...
  if begintext<0:
    ...
    if ind<0:
      g.note("Could not find /textarea tag at end of textbox in HTML for " + articlename + ".")
