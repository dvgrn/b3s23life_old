Instructions For Use Of This Archive, As Of 28 March 2019:
...
5) In Golly, run glider-gun-builderv2.8.py.  New folders 'guns' and 'LHguns' will be created in the
same folder as the script.

----------------------------------

The script works according to the current README, so if the ceebo/glider_guns repository has been
updated since 28 March 2019, the script may report (as "missing") some revised guns that it is
