...
# Scrapes conwaylife.com forums to find posted rules to be added to LifeWiki Rules: namespace
# Can be adapted to retrieve rules only from new posts numbered greater than 86262
#   (the highest post number at the time this script was run in mid-December 2019)
# TODO: This will mean discarding any rules found with a lastpost value less than 86263.
...
outfolder = "c:/users/{username}/Desktop/patfiles/"

postset=set()
ruledict={}

ptr =  86262 # started at 0 on previous run
